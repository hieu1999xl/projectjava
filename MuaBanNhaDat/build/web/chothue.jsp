                            ...
                            <div class="col-gr-100per">
                                <div id="MainContent_PostNews1_pnDangtin">
                                    ...
                                    <div class="post-title">
                                        <h4 class="title text-uppercase fweight-bold" style="color:#000;background: rgba(255,255,208,0.4)" >Thông tin cơ bản
                                        </h4>
                                    </div>
                                    <div class="post-field">
                                        <label class="first" style="color:#000;">Loại nhà đất (<span class="red-clr">*</span>)</label>
                                        <div class="post-field-option set-relative">
                                            <select name="loainhadat" class="form-control" style="background: rgba(255,255,208,0.4)000;" >
                                ...
                                <select name="category" style="border: 2px solid #000;width: 665px;height: 47px;border-radius: 10px;margin-top: 3px;padding-top: 3px;padding-left: 13px;">
                                    <option value="1">Cho thuê căn hộ chung cư</option>
                                    <option value="2">Cho thuê nhà riêng</option>
                                    <option value="3">Cho thuê nhà mặt phố</option>
                                    <option value="4">Cho thuê nhà trọ,phòng trọ</option>
                                    <option value="5">Cho thuê văn phòng</option>
                                    <option value="6">Cho thuê cửa hàng,ki ốt</option>
                                    <option value="7">Cho thuê cửa hàng,ki ốt</option>
                                    <option value="8">Cho thuê mặt bằng</option>
                                    <option value="9">Cho thuê nhà kho</option>
                                </select>
                            </div>
                                    <div class="post-field mg-top-0" style="padding-top: 25px;">
                                        <label class="first" >Giá</label>
                                        <input name="gia" type="text" id="txtDiadiem" class="form-control" style="width:210px;background: rgba(255,255,208,0.4)"  />
                                    </div>
<!--                                    <div class="post-field mg-top-0" style="padding-top: 25px;">
                                        <label class="first" >category</label>
                                        <input name="gia" type="text" id="txtDiadiem" class="form-control" style="width:210px;background: rgba(255,255,208,0.4)"  />
                                    </div>-->
                                    <div class="post-field mg-top-0" style="padding-top: 25px;">
                                        <label class="first" >Diện Tích(m<sup>2</sup>)</label>
                                        <input name="dientich" type="text" id="txtDiadiem" class="form-control" style="width:210px;background: rgba(255,255,208,0.4)" />
                                    </div>

                                    <div class="post-field">
                                        <label class="first">Địa điểm (<span class="red-clr">*</span>)</label>
                                        <div class="post-field-option">
                                            <input name="diadiem" style="background: rgba(255,255,208,0.4)" type="text" id="txtDiadiem" class="form-control" />
                                        </div>
                                    </div>
                                    <div class="clearfix"></div>
                                    <div style="background: rgba(255,255,208,0.4);color:#000;padding:26px;margin-top:30px;">
                                        <h4>THÔNG TIN KHÁC</h4>
                                    </div>
                                    <div class="post-field huongnha">
                                        <label class="first  pull-left" >Mặt tiền (m<sup>2</sup>)</label>
                                        <div class="post-field-option">
                                            <input name="matien" type="text" maxlength="6" id="txtMattien" style="background: rgba(255,255,208,0.4)" class="form-control w-230  pull-left" />
                                            <label class="mg-left-40 mg-right-5  pull-left" >Đường trước nhà (m<sup>2</sup>)</label>
                                            <input name="duongtruocnha" type="text" maxlength="6" id="txtDuongtruocnha" class="form-control w-230  pull-left" style="background: rgba(255,255,208,0.4)" />
                                            <label class="mg-left-40 mg-right-5 pull-left">Hướng nhà</label>
                                            <select name="huongnha" style="color:#000; background: rgba(255,255,208,0.4)" id="cboDirectionPost" class="form-control w-230 mg-right-0">
                                    ...
                                    <div class="post-field huongnha">
                                        ...
                                        <div class="post-field-option">
                                            <input name="sotang" type="number"  id="txtMattien" class="form-control w-230  pull-left" style="margin-right: 75px;background: rgba(255,255,208,0.4)" />
                                            <label class="mg-left-40 mg-right-5  pull-left">Số phòng</label>

                                            <input name="sophong" type="number"  id="txtDuongtruocnha" class="form-control w-230  pull-left" style="margin-right: 18px;background: rgba(255,255,208,0.4)" />
                                            <label class="mg-left-40 mg-right-5 pull-left">Số toilet</label>
                                            <input name="sotoilet" type="number"  id="txtDuongtruocnha" class="form-control w-230  pull-left" style="background: rgba(255,255,208,0.4)" />
                                        </div>
                                    </div>
                                    ...
                                    <div class="post-field mg-bottom-20">
                                        ...
                                        <div class="post-field-option">
                                            <input name="tieude" style="background: rgba(255,255,208,0.4)" type="text" maxlength="150" id="txtTieude" class="form-control" />
                                    ...
                                    <div class="post-field set-relative mg-top-0">
                                        ...
                                        <div id="boxarea" class="post-field-option">
                                            <textarea name="mota" style="background: rgba(255,255,208,0.4)" id="tarNoidung" cols="60" rows="5" maxlength="3000" class="form-control" style="padding: 8px 15px 25px;"></textarea>
                                            ...
                                            <div id="tarNoidung_counter" class="counter-noidung" style="background: rgba(255,255,208,0.4);color:#000;">
                                                1/3000 kí tự
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="post-field mg-bottom-20">
                                        ...
                                        <div class="post-field-option">
                                            <input name="hoten" type="text" id="txtHovaten" class="form-control w-390" style="background: rgba(255,255,208,0.4)" />
                                        </div>
                                    </div>
                                    <div class="post-field mg-bottom-20">
                                        <label class="first">Địa Chỉ (<span class="red-clr">*</span>)</label>
                                        <div class="post-field-option">
                                            <input name="diachi" type="text" id="txtHovaten" class="form-control w-390" style="background: rgba(255,255,208,0.4)" />
                                        </div>
                                    </div>
                                    <div class="post-field mg-bottom-20">
                                        <label class="first">Điện Thoại (<span class="red-clr">*</span>)</label>
                                        <div class="post-field-option">
                                            <input name="dienthoai" type="text" id="txtHovaten" class="form-control w-390" style="background: rgba(255,255,208,0.4)" />
                                        </div>
                                    </div>
                                    <div class="post-field mg-bottom-20">
                                        <label class="first">Email (<span class="red-clr">*</span>)</label>
                                        <div class="post-field-option">
                                            <input name="email" type="text" id="txtHovaten" class="form-control w-390" style="background: rgba(255,255,208,0.4)" />
                                        </div>
                                    </div>
                                    <div class="clear"></div>
                                    <div >
                                        <span>
                                            <input type="submit" style="font-size: 30px;width: 166px;border: 1px solid #fff;border-radius: 5px;background: #d9534f;color: #fff; margin-bottom: 2em; "  value="Đăng Tin">
                                        </span>
                                    </div>
                                </div>
                            </div>
