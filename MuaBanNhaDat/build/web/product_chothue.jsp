            ...
            <div class="container">
                <div class="content">
                    <div class="content-top">
                        <h3 style="color: #000" class="future">Bài đăng nhà đất cho thuê</h3>
                    <%
                    ...
                    <div class="col-md-4 md-col" style="margin-top:30px;">
                        <div  class="col-md" style="background:rgba(0,0,0,0.4); margin-bottom: 5em;">
                            ...
                            <div class="top-content">
                                <h5><a style="color:#000;" href="single.jsp?ChoThueID=<%=c.getChothue_id()%>"> <%=c.getChothue_tieude()%></a></h5>
