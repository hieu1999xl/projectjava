    ...
    <body>
        ...
        <div class="container">
            <div id="top-phongthuy">
                ...
                <div class="topicpath topicpath-border"><ul><li><a href="index.jsp">Trang chủ</a></li><li>Nội-Ngoại thất <span> > <%out.print(PhongThuyDAO.getChiTiet(i).getPhongThuy_TieuDe() ); %></span></li></ul></div>
        </div>
       
          <div class="img_mid">
              <image src="<%out.print(PhongThuyDAO.getChiTiet(i).getPhongThuy_Image()); %>"></image>
              <div class="content_img">
                  <p>Ảnh:  <%out.print(PhongThuyDAO.getChiTiet(i).getPhongThuy_TieuDe()); %></p>
              </div>
             </div> 
