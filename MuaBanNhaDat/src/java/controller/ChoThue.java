    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            String loainhadat = request.getParameter("loainhadat");
              String category_chothue_id = request.getParameter("category");
            String loainhatdatt = "";
            ...
            }else
            {
             ...
             int k = 0;
        if (category_chothue_id.equals("1")) {
            k = 1;
        } else if (category_chothue_id.equals("2")) {
            k = 2;
        } else if (category_chothue_id.equals("3")) {
            k = 3;
        } else if (category_chothue_id.equals("4")) {
            k = 4;
        } else if (category_chothue_id.equals("5")) {
            k = 5;
        
        } else if (category_chothue_id.equals("6")) {
            k = 6;
        } else if (category_chothue_id.equals("7")) {
            k = 7;
        } else if (category_chothue_id.equals("8")) {
            k = 8;
        } else {
            k = 9;
        }
            ...
            {
                request.setAttribute("c", "Đang Đợi Admin Phê Duỵệt");
