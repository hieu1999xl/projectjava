...
public class ChoThueDAO {
    ...
    public static boolean insert_chothue(ChoThue c) throws SQLException {
        ...
        try {        
            String sql ="insert into chothue(category_chothue_id,chothue_loainhadat,chothue_gia,chothue_dientich,"
            ...
            ps.setInt(1, c.getCategory_chothue_id());
            ps.setString(2, c.getChothue_loainhadat());
            ps.setDouble(3, c.getChothue_gia());
            ps.setDouble(4, c.getChothue_dientich());
            ps.setString(5, c.getChothue_diadiem());
            ps.setDouble(6, c.getChothue_matien());
            ps.setDouble(7, c.getChothue_duongtruocnha());
            ps.setString(8, c.getChothue_huongnha());
            ps.setDouble(9, c.getChothue_sotang());
            ps.setInt(10, c.getChothue_sophong());
            ps.setInt(11, c.getChothue_sotoilet());
            ps.setString(12, c.getChothue_tieude());
            ps.setString(13, c.getChothue_mota());
            ps.setString(14, c.getChothue_hinhanh());
            ps.setString(15, c.getChothue_hoten());
            ps.setString(16, c.getChothue_diachi());
            ps.setString(17, c.getChothue_dienthoai());
            ps.setString(18, c.getChothue_email());
            ps.setInt(19, c.getChothue_status());
            ps.setString(20, c.getChothue_ngaydang());
