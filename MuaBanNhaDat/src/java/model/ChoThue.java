...
public class ChoThue 
{
    ...
    private int category_chothue_id;
    //thong tin co ban
    ...
    public int getCategory_chothue_id() {
        return category_chothue_id;
    }

    public void setCategory_chothue_id(int category_chothue_id) {
        this.category_chothue_id = category_chothue_id;
    }
