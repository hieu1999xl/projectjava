     ...
     <body style="background-image: linear-gradient(to left bottom, #F2E3C6 0%, #A7A1A5 100%)" >
        ...
        <jsp:include page="header.jsp"></jsp:include>
            <div class="container" >
                <div class="container">
                    <div class="account">
                        <h2 class="account-in" style="color:#000;">Đăng Nhập Tài Khoản</h2>
                        ...
                        <% }%>
                        <div>
                            <span style="color:#000;">Tên Đăng Nhập </span>
                            <input type="text" name="username">
                        </div> 	
                        <div> 
                            <span class="word" style="color:#000;margin-right:33px;">Mật Khẩu </span>
