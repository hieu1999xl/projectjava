    ...
    <body style="background:url(video/bann.jpg) fixed;color:white;">
        ...
        <div id="content" style="background:rgba(0,0,0,0)">
            ...
            <div>   
                ...
                <h3 style="color:white;">Danh Sách Bài Đăng Cho Thuê Của Thành Viên</h3>
                <table id="danhmuc">
                    <tr>
                        <th>Số Thứ Tự</th>
                        <th>Bài Đăng</th>
                    ...
                    <tr>
                        <td><%=countt%></td>
                        <td><img style="width:100px;height:50px;" src="<%=ct.getChothue_hinhanh()%>" >
                            <span><%=ct.getChothue_tieude()%></span>
                        </td>
                        <td><%=ct.getChothue_hoten()%></td>
                        <td><%=ct.getChothue_loainhadat()%></td>
                        <%
                        ...
                        <td><%
                            if (ct.getChothue_status() == 0) {
                            %>
                            <span style="border: 2px dashed red;"><a style="color: rgba(122,231,0,0.8);font-size:15px;" href="MoHinh.jsp?ChoThueID=<%=ct.getChothue_id()%>"><i class="fas fa-unlock-alt"></i>Đi Duyệt</a></span>
                            <%
                                }
                            %>
                            <span><a href="DuyetBai?command=xoa&ChoThueID=<%=ct.getChothue_id()%>"><i class="fas fa-trash-alt">Xóa</i></a></span></td>
