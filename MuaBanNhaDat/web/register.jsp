     ...
     <body style="background-image: linear-gradient(to left bottom, #F2E3C6 0%, #A7A1A5 100%)" >
        ...
        <div class="container"  >
            ...
            <%response.setContentType("text/html; charset=UTF-8"); %>
                <div class="container" >
                    <div class="account">
                        <h2 class="account-in" style="color:#000;">Đăng Ký Tài Khoản</h2>
                        ...
                        <div>
                            <span class="mail" style="color:#000;">Họ Và Tên:*</span>
                        ...
                        <div> 	
                            <span class="mail" style="color:#000;">Email/Gmail*</span>
                        ...
                        <div> 
                            <span class="word" style="color:#000;">Password *</span>
                        ...
                        <div> 
                            <span class="word" style="color:#000;">Nhập Lại Password *</span>
                        ...
                        <div> 
                            <span class="word" style="color:#000;">Địa Chỉ</span>
                        ...
                        <div> 
                            <span class="word" style="color:#000;">Số Điện Thoại</span>
